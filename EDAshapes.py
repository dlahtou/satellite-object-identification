...
def train_keras_model(x, y, n_channels=20, save_filepath='unnamed_model.h5', sq_dims=256):
    with tf.device('/gpu:0'):
        ...
        final_re = Conv2D(512, [3, 3], activation='relu', padding='same')(bn_10)
        drop_11 = Dropout(0.1)(final_re)
        bn_11 = BatchNormalization(momentum=0.1)(drop_11)
        final_re2 = Conv2D(512, [3, 3], activation='relu', padding='same')(bn_11)
        ...
        layer_14 = Conv2D(256, [3, 3], activation='relu', padding='same')(bn_12)
        drop_13 = Dropout(0.1)(layer_14)
        bn_13 = BatchNormalization(momentum=0.1)(drop_13)
        layer_15 = Conv2D(256, [3, 3], activation='relu', padding='same')(bn_13)
        ...
        layer_18 = Conv2D(128, [3, 3], activation='relu', padding='same')(bn_14)
        drop_15 = Dropout(0.1)(layer_18)
        bn_15 = BatchNormalization(momentum=0.1)(drop_15)
        layer_19 = Conv2D(128, [3, 3], activation='relu', padding='same')(bn_15)
