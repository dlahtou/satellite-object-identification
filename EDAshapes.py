...
def train_keras_model(x, y, n_channels=20, save_filepath='unnamed_model.h5', sq_dims=256):
    with tf.device('/gpu:0'):
        ...
        drop_1 = Dropout(0.1)(layer_1)
        bn_1 = BatchNormalization(momentum=0.1)(drop_1)
        layer_2 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_1)

        # 128
        layer_3 = MaxPooling2D(pool_size=(2,2))(layer_2)
        drop_2 = Dropout(0.1)(layer_3)
        bn_2 = BatchNormalization(momentum=0.1)(drop_2)
        layer_4 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_2)
        drop_3 = Dropout(0.1)(layer_4)
        bn_3 = BatchNormalization(momentum=0.1)(drop_3)
        layer_5 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_3)

        # 256
        layer_6 = MaxPooling2D(pool_size=(2,2))(layer_5)
        drop_4 = Dropout(0.1)(layer_6)
        bn_4 = BatchNormalization(momentum=0.1)(drop_4)
        layer_7 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_4)
        drop_5 = Dropout(0.1)(layer_7)
        bn_5 = BatchNormalization(momentum=0.1)(drop_5)
        layer_8 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_5)

        # 512
        layer_9 = MaxPooling2D(pool_size=(2,2))(layer_8)
        drop_6 = Dropout(0.1)(layer_9)
        bn_6 = BatchNormalization(momentum=0.1)(drop_6)
        layer_10 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_6)
        drop_7 = Dropout(0.1)(layer_10)
        bn_7 = BatchNormalization(momentum=0.1)(drop_7)
        layer_11 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_7)

        # 1024
        final_depth = MaxPooling2D(pool_size=(2,2))(layer_11)
        drop_8 = Dropout(0.1)(final_depth)
        bn_8 = BatchNormalization(momentum=0.1)(drop_8)
        final_conv = Conv2D(64, [3,3], activation='relu', padding='same')(bn_8)
        drop_9 = Dropout(0.1)(final_conv)
        bn_9 = BatchNormalization(momentum=0.1)(drop_9)
        final_conv2 = Conv2D(64, [3,3], activation='relu', padding='same')(bn_9)

        # 512
        final_upconv = Conv2DTranspose(64, (2,2), strides=(2,2), padding='same')(final_conv2)
        final_con = concatenate([layer_10, final_upconv])
        drop_10 = Dropout(0.1)(final_con)
        bn_10 = BatchNormalization(momentum=0.1)(drop_10)
        final_re = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_10)
        drop_11 = Dropout(0.1)(final_re)
        bn_11 = BatchNormalization(momentum=0.1)(drop_11)
        final_re2 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_11)

        # 256
        layer_12 = Conv2DTranspose(64, (2,2), strides=(2,2), padding='same')(final_re2)
        layer_13 = concatenate([layer_7, layer_12])
        drop_12 = Dropout(0.1)(layer_13)
        bn_12 = BatchNormalization(momentum=0.1)(drop_12)
        layer_14 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_12)
        drop_13 = Dropout(0.1)(layer_14)
        bn_13 = BatchNormalization(momentum=0.1)(drop_13)
        layer_15 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_13)
        
        # 128
        layer_16 = Conv2DTranspose(64, (2,2), strides=(2,2), padding='same')(layer_15)
        layer_17 = concatenate([layer_4, layer_16])
        drop_14 = Dropout(0.1)(layer_17)
        bn_14 = BatchNormalization(momentum=0.1)(drop_14)
        layer_18 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_14)
        drop_15 = Dropout(0.1)(layer_18)
        bn_15 = BatchNormalization(momentum=0.1)(drop_15)
        layer_19 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_15)

        # 64
        layer_20 = Conv2DTranspose(64, (2,2), strides=(2,2), padding='same')(layer_19)
        layer_21 = concatenate([layer_1, layer_20])
        drop_16 = Dropout(0.1)(layer_21)
        bn_16 = BatchNormalization(momentum=0.1)(drop_16)
        layer_22 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_16)
        drop_17 = Dropout(0.1)(layer_22)
        bn_17 = BatchNormalization(momentum=0.1)(drop_17)
        layer_23 = Conv2D(64, [3, 3], activation='relu', padding='same')(bn_17)
